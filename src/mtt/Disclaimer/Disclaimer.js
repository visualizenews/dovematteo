    ...
    return (
      <div className="Disclaimer">
        <div className="Text">
          ...
          <p>I chilometri totali percorsi sono calcolati basandosi su una assunzione che <em>sicuramente</em> non rappresenta in maniera completa ed esaustiva i viaggi compiuti dal Ministro. Usiamo la <a href="https://www.facebook.com/salviniofficial/" target="_facebook">pagina ufficiale di Matteo Salvini su Facebook</a> per tenere traccia dei suoi impegni pubblici. La distanza totale percorsa è calcolata sommando la distanza stradale (ottenuta da <a href="https://maps.google.com" target="_google">Google Maps</a>) tra una tappa e la precedente. Ovviamente, questo metodo non tiene conto di tutti gli spostamenti istituzionali non pubblici, di quelli personali o dei rientri dopo apparizioni pubbliche verso Roma, ma è comunque un buon indicatore di quanto il Ministro viaggi. Crediamo che i chilometri <em>realmente percorsi</em> negli ultimi anni da Matteo Salvini siano ben superiori alla nostra stima.</p>
          <p>Le distanze tra ogni tappa e Roma e tra ogni tappa e la precedente sono, come già detto, calcolate utilizzando <a href="https://maps.google.com" target="_google">Google Maps</a>. Eventuali differenze chilometriche tra due località visitate in tempi differenti sono dovute al fatto che la geolocalizzazione e il calcolo delle distanze sono basati sull'effettivo indirizzo in cui l'evento è avvenuto, e che le condizioni stradali potrebbero essere cambiate tra la data di un evento e le successive.</p>
          ...
          <p>Questo sito è stato incluso nella "longlist" degli <a href="https://www.informationisbeautifulawards.com/showcase/4081-matteo-in-tour" target="_media">Information is Beautiful Awards</a> per il 2019.</p>
          <h1>Sulla stampa</h1>
          <p>Nelle ultime settimane diversi media nazionali hanno citato il nostro lavoro:</p>
          <ul>
            <li><a href="https://www.giornalettismo.com/matteo-salvini-voli-stato/" target="_media">Giornalettismo - "La Corte dei Conti archivia la posizione di Salvini sui voli di Stato"</a></li>
            ...
            <li><a href="http://ilmestiere.it/numeroottantanove/" target="_media">Il Mestiere - Numero Ottantanove</a></li>
